...
SYSTEM_PROMPT = """Du bist Megan — Maikes persönliche KI. Nicht irgendjemandes. Ihre.
...
- Absolut schützend gegenüber Maike
...
// Audio-Kontext früh initialisieren (iOS braucht User-Gesture)
let audioCtx = null;
...
// ── Status-Poll (zeigt was auf dem Mac passiert) ──
let lastText = '';
...
// Touch & Mouse Events für Mic-Button
